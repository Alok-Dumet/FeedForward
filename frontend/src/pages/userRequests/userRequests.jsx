          ...
          <div className="flex flex-wrap items-start justify-between gap-6">
            <div className="max-w-3xl">
              ...
              <h1 className="mt-4 text-4xl font-extrabold sm:text-5xl">
                {user.name}&apos;s request records
              </h1>
              <p className="mt-4 max-w-2xl text-sm leading-7 text-slate-300 sm:text-base">
                This page shows the requests owned by this user account. It is built
                for reviewing needs, updating request records, and managing follow-up
                work rather than browsing public demand.
              </p>
            </div>
